      ...
      <div class="container">
         ...
         <div class="row">
             <div class="col-xs-offset-2 col-xs-8">
				...
				<div class="row">
					<div class="col-xs-offset-1 col-xs-4">
						<select class="form-control " id="select_type_time">
				...
				<div class="col-xs-offset-1 col-xs-4">
					<select class="form-control " id="select_value_sensor">
						...
						<?php $result = $transitions->result_array();
							 foreach ($result as $condicoes) {
								 echo "<option value=".$condicoes['id'].">".$condicoes['nome_legivel']."</option>";
							 }
						 ?>
					</select>
				</div>
