<?php
class M_contextosinteresse extends CI_Model {
	...
	private $contextointeresse_trigger;
  	...
  	function pesquisar($select='', $where=array(), $limit=10, $offset=0, $ordem='asc', $perm=FALSE) {
		...
		foreach($query as $arr){
            ...
            $this->db->join('sensores as s', 'relcontextointeresse.sensor_id = s.sensor_id', 'left');
		...
		function salvar() {
            ...
            if ($this->contextointeresse_id == ""){
	            $this->db->insert('contextosinteresse', $arrayCampos);
	            ...
	            $this->db->update('contextosinteresse', $arrayCampos, array("contextointeresse_id"=>$this->contextointeresse_id));
		...
		function excluir() {
            ...
            if ($this->db->delete('contextosinteresse', $arrayCampos))
            	return true;
        	else
        		return false;
		}
